...
import com.daodecode.scalaj.googleoptional
...
### sbt
```
libraryDependencies += "com.daodecode" %% "scalaj-collection" % "0.1.1-SNAPSHOT"
```
### maven
``` xml
<dependency>
...
### sbt
```
libraryDependencies += "com.daodecode" %% "scalaj-googleoptional" % "0.1.1-SNAPSHOT"
```
### maven
``` xml
<dependency>
